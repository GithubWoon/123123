...
public class catchMoles extends JFrame implements ActionListener, Runnable {
    ...
    ImageIcon iconMole = new ImageIcon("hi-main/digda.png");
    ImageIcon iconKingMole = new ImageIcon("hi-main/digda2.png");
    ImageIcon iconHedgehog = new ImageIcon("hi-main/dochi.png");
    ...
    catchMoles() {
        try {
            CursorImage = ImageIO.read(new File("hi-main/kill.png")); // 이미지 파일을 로드
